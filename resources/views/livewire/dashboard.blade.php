<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="space-y-8">
        ...
        <a href="https://discord.gg/CRRzmvS5MK" target="_blank" class="block group">
            <div class="bg-gradient-to-r from-[#5865F2]/20 to-purple-600/20 backdrop-blur-xl rounded-2xl p-6 border border-[#5865F2]/30 hover:border-[#5865F2]/50 transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <div class="w-14 h-14 bg-[#5865F2]/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white mb-1">Join the Vizra Community</h3>
                            <p class="text-gray-400 text-sm">Get help, share your projects, and connect with other developers building AI agents</p>
                        </div>
                    </div>
                    <div class="flex items-center text-[#5865F2] font-medium">
                        <span class="hidden sm:inline mr-2">Join Discord</span>
