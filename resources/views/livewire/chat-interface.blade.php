...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-gray-900 mb-2">Chat Interface</h1>
            <p class="text-gray-600">Interactive conversations with your AI agents</p>
        </div>

        <!-- Agent Selection & Controls -->
        <div class="flex items-center justify-between mb-6 bg-white rounded-2xl p-4 border border-gray-200 shadow-sm">
                ...
                @if(count($registeredAgents) > 0)
                    <div class="flex items-center space-x-3">
                        ...
                        <select id="agent-select"
                                ...
                                class="px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-300 text-sm font-medium text-gray-700 min-w-[220px] transition-all duration-200">
            ...
            <div class="flex items-center space-x-2">
                <button wire:click="openLoadSessionModal"
                        class="inline-flex items-center px-4 py-2.5 bg-gray-50 border border-gray-200 text-sm font-medium rounded-xl text-gray-700 hover:bg-gray-100 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-200">
