...
use AaronLumsden\LaravelAgentADK\Http\Controllers\AgentApiController;
...
//     try {
//         $response = \AaronLumsden\LaravelAgentADK\Facades\Agent::run('weather_reporter', $input, $sessionId);
