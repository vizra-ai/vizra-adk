...
echo "• Packagist will auto-sync within a few minutes"
echo ""
echo -e "${BLUE}View your release:${NC}"
echo "• GitHub: https://github.com/vizra-ai/vizra-adk/releases/tag/v$NEW_VERSION"
echo "• Packagist: https://packagist.org/packages/vizra/vizra-adk"